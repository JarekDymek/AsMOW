...
const categories = [
  ...
  category('ai-aplikacja', 'Bezpieczeństwo aplikacji, AI i tryb testowy', [sources.internal], [
    ...
    item('bank-odpowiedzi', 'Co to jest bank 250 odpowiedzi wzorcowych w Asystencie MOW?', 'To zestaw 250 krótkich, kontrolowanych odpowiedzi w 25 grupach tematycznych oraz wariantów pytań. Lokalny router rozpoznaje sens pytania bez wymagania identycznego brzmienia. Przy pewnym dopasowaniu odpowiada bez zewnętrznego AI, a przy niejasności dopytuje.', 'Bank ogranicza koszty, czas oczekiwania i ryzyko halucynacji. Zewnętrzne AI pozostaje do pytań nowych, złożonych lub niepewnych.', ['bank 250 odpowiedzi', 'odpowiedzi wzorcowe', 'rozpoznawanie intencji', 'bez AI'], { aliases: ['Bank 250 odpowiedzi wzorcowych i rozpoznawania intencji', 'Po co bank odpowiedzi w aplikacji?', 'Czym jest bank odpowiedzi i intencji?'] }),
